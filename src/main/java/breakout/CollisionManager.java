...
/**
 * CollisionManager handles detecting collisions between sprites in the game, and then handling the
 * collisions by calling the handleCollisionWith() function for the Sprite objects that have
 * collided.
 */
public class CollisionManager {
  ...
  /**
   * Check for collisions between Sprite objects that are moving and Sprite objects. Checking for
   * collisions between just moving sprites and other sprites saves computation since two sprites
   * that aren't moving will not be able to collide.
   */
